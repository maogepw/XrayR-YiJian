...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/maogepw/XrayR-YiJian/main/XrayR.service"
    ...
    curl -o /etc/XrayR/config.yml -Ls https://cdn.jsdelivr.net/gh/maogepw/XrayR-YiJian/config.yml
